    ...
    <div class="container" style="margin-top:100px;border-radius : 5px;background-image: linear-gradient(122deg, #5421ff, #00d0ff 81%, #9dfeca)">
      <div class="row">
        <div class="col-md-6">
          ...
          <p class="text-white px-5 py-2">Unleash the true off-road beast within your vehicle with our top-of-the-line lift kits. Whether you crave superior ground clearance or want to conquer rugged terrains with ease, our lift kits are designed to take your ride to new heights. Our team of experts will install the perfect lift kit that not only enhances the aesthetics of your vehicle but also improves its performance capabilities.</p>
          <span class="px-5">
