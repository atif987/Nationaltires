  ...
  <section>
    <div class="bloc-video">
      ...
      <div class="content-video">
        <h1 class="text-yellow">National tires & auto repairs</h1>
    ...
    <div class="container setblackbackgroundcolor" style="margin-top:100px;border-radius : 5px;">
      <div class="row">
        <div class="col-md-6">
          ...
          <span class="px-5">
            <button type="button" class="btn pb-2" style="font-weight: 600;" onclick="window.location.href = 'schedule-service.php';">
  ...
  <section>
    <div class="container setblackbackgroundcolor" style="border-radius:10px;margin-top:5%;" >
      ...
      Unparalleled Expertise and Quality: Trust your vehicle's needs to the industry leaders in National Tires & Auto Repairs. Our team of highly skilled technicians brings years of experience, ensuring top-notch service and unrivaled attention to detail .
      </div>
      <div class="row mt-4">
