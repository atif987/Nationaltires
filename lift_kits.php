  ...
  <!-- :: Intro-->
  <section>
    <div class="container setblackbackgroundcolor" id="lift-kits-first-section">
      <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-6 p-5">
          <img src="assets/images/vectors/lifting.webp" id="services_first_section" class="img-fluid" alt="Responsive Image">
        </div>
      </div>
  </section>
